...
export function Hero() {
	...
	return (
		<div className="relative mx-auto my-4 flex w-full max-w-7xl flex-col items-center justify-center overflow-hidden rounded-xl font-zenmaru">
			<h2 className="relative z-20 mx-2 max-w-4xl rounded-xl bg-teal-300 bg-opacity-50 p-4 text-center text-4xl font-extrabold text-teal-700 [text-shadow:_2px_3px_0_rgb(255_255_255_/_100%)] md:p-8 md:text-5xl">
				『キャリエモン』<span className="text-2xl md:text-3xl">で</span>
			...
			<div className="relative z-20 mb-8 flex flex-wrap items-center justify-center gap-4">
				<Button
					asChild
					className="my-1 h-9 cursor-pointer rounded-sm bg-amber-300 px-2 py-0.5 text-sm font-semibold text-gray-700 no-underline hover:bg-amber-300 hover:opacity-80 sm:px-6 md:text-base"
				>
				...
				<Button
					asChild
					className="my-1 h-9 cursor-pointer rounded-sm bg-teal-600 px-2 py-0.5 text-sm font-semibold text-white no-underline hover:bg-teal-600 hover:opacity-80 sm:px-6 md:text-base"
				>
			...
			{/* overlay */}
			<div className="absolute inset-0 z-10 w-full bg-teal-300/40" />
			<ThreeDMarquee
